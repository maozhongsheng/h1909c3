...
<body class="gray-bg">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_in" method="post" action="inStu.htm" enctype="multipart/form-data">
						选择上传文件：<input type="file" name="file"  value=""/>
	...
	<!-- 柱状图 -->
	<div class="modal fade" id="modal_user_bar" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>学生姓名：</td>
								<td><input type="text" id="username" name="sdname"
								...
								<td>学生爱好：</td>
								<td>
								<input type="checkbox"  name="sdhobby" value="LOL"/>LOL
								<input type="checkbox"  name="sdhobby" value="DNF"/>DNF
								<input type="checkbox"  name="sdhobby" value="CF"/>CF
							...
							<tr>
								<td>班级：</td>
								<td colspan="4">
									<select class="form-control" name="mid" id = "roleid" aria-required="true" required>
	...
	function initEditUser(getSelection){
		...
		$('#roleid').val(getSelection.mid);
		$('#username').val(getSelection.sdname);
		$('#sdsex').val(getSelection.sdsex);
		$('#sdbirth').val(new Date(getSelection.sdbirth).Format('yyyy-MM-dd'));
		var hobbys=getSelection.sdhobby
		if(hobbys != null && hobbys !=''){
		var  arr=	hobbys.split(",")
