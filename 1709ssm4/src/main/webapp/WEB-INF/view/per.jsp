...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">员工性名 </span>
					...
					<form id="form_user" method="post" action="reservePer.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>入职时间：</td>
								<td colspan="2">
								<input type="date" name="joindate" id="bid">
								</td>
							</tr>
						</table>
	...
	function initEditUser(getSelection){
		...
		$('#username').val(getSelection.pName);
		$('#bid').val(new Date(getSelection.joindate).Format('yyyy-MM-dd'));
