...
<body class="gray-bg">
	<div class="panel-body">
		...
		<div class="modal fade" id="modal_user_echarts" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<div id="did" style="width:600px ;height: 400px"></div>
		...
		<div class="modal fade" id="modal_user_class" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_class" method="post" action="addClass.htm" enctype="multipart/form-data">
						<input type="text" name="cname" />
					
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_class_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<div class="modal fade" id="modal_user_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStu.htm" enctype="multipart/form-data">
						<input type="hidden" name="sid" id="hidden_txt_userid" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>学生姓名：</td>
								<td><input type="text" id="username" name="sname"
							...
							<tr>
								<td>班级：</td>
								<td colspan="2">
									<select class="form-control" name="cid" id = "roleid" aria-required="true" required>
							...
							<tr>
								<td valign="middle">爱好：</td>
								<td colspan="4">
								<input type="checkbox"   value="篮球" name="hobbys">篮球 
								<input type="checkbox" value="LOL" name="hobbys">LOL
								<input type="checkbox" value="文杰" name="hobbys">文杰
								<input type="checkbox" value="GG" name="hobbys">GG 
								</td>
	...
	$(function () {
	  ...
	  //导入提交事件
	    $("#submit_form_class_btn").click(function(){
	    	$("#form_class").submit();
	    ...
	    var validator = $("#form_in").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
